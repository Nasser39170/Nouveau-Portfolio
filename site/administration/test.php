<!DOCTYPE html>
  ...
  <?php 
    ...
    <h2>Objectif</h2>
   <font color="white" <p>Realiser un CRUD pour le conciere d'un immeuble.
...
Il devra aussi pouvoir depuis celle-ci, pouvoir afficher les intervention d'une certaine date, les interventions réalisées à tel ou tel étage...</p><p>n'hesiter pas à vous inscrire pour accéder à l'administration</p></font>
<p class="text-center"><a href="index.php">Retour</a></p>
      <div class="user-box">
